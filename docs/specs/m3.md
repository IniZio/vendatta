...
mochi workspace create my-project --provider [docker|lxc|qemu] --remote node1

# Start workspace (starts environment, services, maps ports)
mochi workspace up my-project

# Connect (automatic SSH into environment)
mochi workspace connect my-project

# Stop (clean shutdown, clear messaging)
mochi workspace down my-project
```

### Configuration Focus:
- **Single `.mochi/config.yaml`** per project
