...
## Objective
Implement a comprehensive end-to-end test suite that validates all core nexus functionality and identifies issues with the current implementation.
...
1. **TestnexusInit** - Basic initialization and scaffolding
2. **TestnexusDevBasic** - Session creation and worktree setup
3. **TestnexusServiceDiscovery** - Environment variable injection ⚠️ **FAILS**
4. **TestnexusSessionManagement** - Multiple session handling
5. **TestnexusWorktreeIsolation** - Branch isolation verification
