...
- **Pattern**: `mochi_SERVICE_{SERVICE_NAME}_URL={PROTOCOL}://localhost:{PORT}`
- **Examples**:
...
- ✅ Variables accessible in container shell: `env | grep mochi_SERVICE`
...
## 🎯 Success Criteria
- ✅ `mochi_SERVICE_*_URL` variables available in running containers
