...
- **Pattern**: `nexus_SERVICE_{SERVICE_NAME}_URL={PROTOCOL}://localhost:{PORT}`
- **Examples**:
...
- ✅ Variables accessible in container shell: `env | grep nexus_SERVICE`
...
## 🎯 Success Criteria
- ✅ `nexus_SERVICE_*_URL` variables available in running containers
