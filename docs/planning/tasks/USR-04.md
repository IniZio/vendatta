...
### **CLI Integration** (`cmd/nexus/workspace.go`)
- `nexus workspace link --ide vscode`: Generate IDE-specific links
- `nexus workspace open --ide cursor`: Open workspace in specified IDE
