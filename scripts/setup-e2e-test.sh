...
echo "🚀 Setting up mochi E2E Test Environment"
...
TEST_ROOT="/tmp/mochi-e2e-$(date +%s)"
...
cat > package.json << 'EOF'
{
  ...
  "version": "1.0.0",
  "description": "Test fullstack application for mochi e2e testing",
  "scripts": {
...
<body>
  <div id="root">
    ...
    <p>This is a test application for mochi e2e testing.</p>
  </div>
...
This is a comprehensive test application for mochi e2e testing. It includes:
