...
echo "🚀 Setting up nexus E2E Test Environment"
...
TEST_ROOT="/tmp/nexus-e2e-$(date +%s)"
...
cat > package.json << 'EOF'
{
  ...
  "version": "1.0.0",
  "description": "Test fullstack application for nexus e2e testing",
  "scripts": {
...
<body>
  <div id="root">
    ...
    <p>This is a test application for nexus e2e testing.</p>
  </div>
...
This is a comprehensive test application for nexus e2e testing. It includes:
